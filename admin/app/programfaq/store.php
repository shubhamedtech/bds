<?php
if (isset($_POST['question'], $_POST['answer'], $_POST['program_id'])) {
    ...
    $insertQuery = "INSERT INTO `programfaq`(`Program_ID`, `Questions`, `Answers`) VALUES ('$program_id', '$question', '$answer')";
