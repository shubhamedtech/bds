            ...
            <div class="col-xl-12">
                <div class="card dz-card" id="accordion-four">
                    <div class="card-header flex-wrap d-flex justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" onclick="add('blogs','md')" data-bs-target="#modalGrid">Add Blogs </button>
                    </div>
                    <!-- /tab-content -->
            ...
            'columns': [{
                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        ...
                        return '<label class="switch" for="status-switch-' + row.ID + '"> <input onclick="changeStatus(&#39;blogs&#39;, &#39;' + row.ID + '&#39;)" type="checkbox" ' + checked + ' id="status-switch-' + row.ID + '"><span class="slider round"></span></label>';
                    },
                    visible: true
                },

                {
                    data: 'ID',
                    render: function(data, type, row) {
                        return '<div class="ms-auto"><a href="javascript:void(0);" onclick="edit(&#39;blogs&#39;, &#39;' + data + '&#39, &#39;md&#39;)" class="btn btn-primary btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a><a href="javascript:void(0);" onclick="destroy(&#39;blogs&#39;, &#39;' + data + '&#39)" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a></div>';
                    },
                    visible: true
                },
            ],
