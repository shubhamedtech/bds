...
(function($) {
    ...
    versionSelect.on('change', function() {
		...
		/* if(this.value === 'dark'){
			//jQuery(".nav-header .logo-abbr").attr("src", ".//admin/admin-assets/images/logo-white.png");
			jQuery(".nav-header .logo-compact").attr("src", "/admin/admin-assets/images/logo-text-white.png");
			jQuery(".nav-header .brand-title").attr("src", "/admin/admin-assets/images/logo-text-white.png");
			
			setCookie('logo_src', './/admin/admin-assets/images/logo-white.png');
			setCookie('logo_src2', '/admin/admin-assets/images/logo-text-white.png');
		}else{
			jQuery(".nav-header .logo-abbr").attr("src", ".//admin/admin-assets/images/logo.png");
			jQuery(".nav-header .logo-compact").attr("src", "/admin/admin-assets/images/logo-text.png");
			jQuery(".nav-header .brand-title").attr("src", "/admin/admin-assets/images/logo-text.png");
			
			setCookie('logo_src', './/admin/admin-assets/images/logo.png');
			setCookie('logo_src2', '/admin/admin-assets/images/logo-text.png');
		} */
