                    ...
                    <div class="col-xl-12">
                        <div class="row">
                                        ...
                                        <div class="card bg-primary text-white">
                                            <div class="card-header border-0 flex-wrap">
                                                ...
                                                <div class="avatar-list avatar-list-stacked me-2">
                                                    <img src="/admin/admin-assets/images/contacts/pic555.jpg" class="avatar rounded-circle" alt="">
                                                    <img src="/admin/admin-assets/images/contacts/pic666.jpg" class="avatar rounded-circle" alt="">
                            ...
                            <div class="col-xl-3 col-sm-6">
                                <div class="card bg-success rainbow-box" style="background-image: url(/admin/admin-assets/images/rainbow.gif);background-size: cover;background-blend-mode: luminosity;">
                                    <div class="card-header border-0">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="d-flex pt-3">
                                            <div class="avatar-list avatar-list-stacked">
                                                <img src="/admin/admin-assets/images/contacts/pic555.jpg" class="avatar rounded-circle" alt="">
                                                <img src="/admin/admin-assets/images/contacts/pic666.jpg" class="avatar rounded-circle" alt="">
                                                <img src="/admin/admin-assets/images/contacts/pic777.jpg" class="avatar rounded-circle" alt="">
                                            </div>
